...
import { assertInside, listProjectSourceFiles, safeRelativePreviewPath, sanitizePathComponent, workspaceContext, } from "./workspace-paths.js";
...
function isInternalPreviewPath(path) {
